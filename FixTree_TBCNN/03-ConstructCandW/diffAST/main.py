...
def create(PATH, fileName):
    # temp_text = os.system("gumtree parse "+PATH+"old_"+fileName)
    # # print(temp_text)
    # with open(PATH+"old_"+fileName+".json", "w") as f:
    #     f.write(str(temp_text))
    #
    # temp_text = os.system("gumtree parse "+PATH+"new_"+fileName)
    # with open(PATH+"new_"+fileName+".json", "w") as f:
    #     f.write(str(temp_text))
    #
    # temp_text = os.system("gumtree parse "+PATH+"old_"+fileName + " "+ "new_"+fileName)
    # with open(PATH+"diffscript_"+fileName+".txt", "w") as f:
    #     f.write(str(temp_text))
    # os.system()



    astBefore = AST(PATH+"old_"+fileName+".json")
    astAfter = AST(PATH+"new_"+fileName+".json")
    diff = DiffOperate(PATH+"diffscript_"+fileName+".txt")
...
#     # print(dot)
#     dot.render('test-output/round-table2.gv', view=False)
#
#
